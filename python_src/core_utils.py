...
def calculate_power_detailed(hp, atk, def_, skill1, skill2, burst, part_options, cube_lvl, col_grade, col_skill1, col_skill2, weapon, nikke_data=None):
    try:
        ...
        col_coeff_val = 0
        if col_grade == "R": col_coeff_val = col_skill1 + 6.33
        elif col_grade == "SR": col_coeff_val = col_skill1 + col_skill2 + 10.66
        ...
        details = {
            ...
            "col_pct": (col_coeff_val / (4+4+10.66)) * 100 if col_grade != "None" else 0,
